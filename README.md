...
Thirty-six states and D.C. provided school-level or district-level vaccination data. When a state did not provide MMR-specific figures, an overall vaccination rate reflecting students up-to-date on all required vaccines was used. MMR rates reflect two doses of the vaccine, and in some states represent the vaccination for measles specifically.
